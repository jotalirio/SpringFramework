...
public class LoginControllerImpl implements LoginController {
  ...
  // We can detect if the user is logging out using the '?logout' param
  ...
  public String login(@RequestParam(value = "error", required = false) String error, 
    ...
    if (logout != null) {
      model.addAttribute(Constants.ATTRIBUTE_FLASH_SUCCESS_KEY, "You have successfully logged out !!!.");
    }
